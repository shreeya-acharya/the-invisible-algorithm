  ...
  return (
    <div className="min-h-screen bg-[#080F1D] text-white overflow-x-hidden">
      ...
      <style>{`
        ...
        @keyframes scoreGlow {
          0%, 100% {
            filter: drop-shadow(0 0 8px rgba(183,196,255,.15));
          }
          50% {
            filter: drop-shadow(0 0 24px rgba(183,196,255,.38));
          }
        }
      ...
      {/* =========================================================
          NAVBAR
      ========================================================== */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#080F1D]/75 backdrop-blur-xl border-b border-white/[0.06]">
        <div className="max-w-[1280px] mx-auto px-5 md:px-8 h-[76px] flex items-center justify-between">
          <button
            onClick={() => onNavigate('landing')}
            className="font-bold text-lg tracking-tight hover:text-[#b7c4ff] transition-colors"
          >
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/[0.04] border border-white/[0.06]">
              <div className="w-7 h-7 rounded-full bg-[#b7c4ff]/15 border border-[#b7c4ff]/20 flex items-center justify-center text-xs font-bold text-[#b7c4ff]">
                {initials}
              </div>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="dashboard-glow absolute top-[100px] left-[8%] w-[420px] h-[420px] rounded-full bg-[#7788ff]/[0.055] blur-[120px]" />
        <div className="dashboard-glow absolute bottom-[10%] right-[5%] w-[350px] h-[350px] rounded-full bg-[#9b8cff]/[0.045] blur-[120px]" />
      </div>

      {/* =========================================================
          MAIN
      ========================================================== */}
      <main className="relative pt-[116px] pb-20 px-5 md:px-8 max-w-[1280px] mx-auto">
        ...
        {loading ? (
          ...
          <div className="space-y-8">
            ...
            {/* =====================================================
                WELCOME
            ====================================================== */}
            <section className="dashboard-entry relative overflow-hidden rounded-[28px] glass-dashboard soft-grid p-7 md:p-10">

              <div className="absolute right-[-80px] top-[-100px] w-[300px] h-[300px] rounded-full bg-[#b7c4ff]/[0.055] blur-[60px]" />
              ...
              <div className="relative z-10 flex flex-col lg:flex-row justify-between gap-8">
                ...
                <div className="max-w-2xl">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-[10px] font-mono uppercase tracking-[.22em] text-emerald-400">
                      Extension connected
                    </span>
                  </div>

                  <p className="text-xs uppercase tracking-[.25em] text-[#b7c4ff]/70 mb-3">
                    Good morning, {userName}
                  </p>

                  <h1 className="text-3xl md:text-5xl font-bold tracking-[-.04em] leading-tight">
                    Understand your
                    <span className="text-[#b7c4ff]"> information bubble.</span>
                  </h1>

                  <p className="mt-4 text-sm md:text-base text-white/45 max-w-xl leading-relaxed">
                    See how diverse your recommendations are, discover
                    patterns in your feed, and consciously explore beyond
                    what the algorithm usually shows you.
                  </p>
                </div>

                <div className="flex items-end">
                  <div className="px-4 py-3 rounded-xl bg-white/[0.035] border border-white/[0.06]">
              ...
              <div className="dashboard-entry dashboard-card glass-dashboard rounded-[26px] lg:col-span-2 p-7 relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <div className="flex justify-center py-9">
                    ...
                    <div className="relative w-[205px] h-[205px] score-ring rounded-full p-[7px] score-glow">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-white/40 mt-3 leading-relaxed">
                      Higher diversity means your recommendations
                      expose you to a wider range of perspectives.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section className="dashboard-entry glass-dashboard dashboard-card rounded-[26px] p-6 md:p-8">
              ...
              <div className="mt-4 flex justify-between items-center border-t border-white/[0.05] pt-5">
                  ...
                  data.recentSessions.length > 0 ? (
                    data.recentSessions.slice(0, 5).map(
                      (session, index) => (
                        <div
                          key={index}
                          className="group flex items-center gap-4 p-4 rounded-xl hover:bg-white/[0.035] transition-all"
                        >
              ...
              <div className="glass-dashboard rounded-[26px] p-6 relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <p className="text-xs text-white/35 mt-2 leading-relaxed">
                    Try something your algorithm doesn't normally
                    recommend.
                  </p>
            ...
            <section>
              ...
              <button
                ...
                className="text-[10px] font-mono uppercase tracking-widest text-white/20 hover:text-white/45 transition-colors"
              >
