            ...
            <section className="dashboard-entry glass-dashboard dashboard-card rounded-[26px] p-6 md:p-8">
              ...
              <div className="flex flex-col md:flex-row justify-between md:items-end gap-4 mb-7">
                <div>
                  ...
                  <h2 className="text-2xl font-bold mt-2">
                    What your recommendations are about
                  </h2>

                  <p className="text-xs text-white/35 mt-2">
                    Categories detected from the Reels captured by your browser extension.
                  </p>
                </div>
              ...
              <div className="space-y-4">
                ...
                data.categoryBreakdown.length > 0 ? (
                    ...
                    return (
                      <div key={item.category}>
                        ...
                        <div className="h-2 bg-white/[0.05] rounded-full overflow-hidden">
                          <div
                            className="h-full bg-[#b7c4ff]/70 rounded-full transition-all duration-700"
                  ...
                  <div className="py-8 text-center text-xs text-white/30">
                    No Reel categories have been collected yet.
                  </div>
                )}
              </div>
